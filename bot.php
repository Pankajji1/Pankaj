...
$ip=$api["query"];
$failed = file_get_contents('xevil');
@system("clear");
error_reporting(0);
...
// Slow function to print text character by character
function slow($text, $delay = 30000) {
    foreach (str_split($text) as $char) {
        echo $char;
        usleep($delay);  // 30ms delay
        flush();
    }
    echo "\r"; // Har text ke baad ek new line
}

// Color Codes
$green = "\033[1;92m"; // Green (Bright)
$yellow = "\033[1;93m"; // Yellow
$cyan = "\033[1;96m"; // Cyan (Light Blue)
...
$ch = curl_init("https://kingurl.in/api?api=7b96c5467b1a1634a9a0fb9fc9c1cba7c1afdf75&url=$canonical"); // such as http://example.com/example.xml
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
